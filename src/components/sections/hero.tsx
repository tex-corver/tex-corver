...
export default function Hero() {
  ...
  return (
    <Section id="hero">
      <div className="flex flex-col justify-center items-center gap-8 md:gap-12 min-h-[calc(80vh-40rem)] md:min-h-[calc(80vh-20rem)]">
        ...
        >
          {t("hero.button")}
          <ArrowRightIcon className="w-4 md:w-6 h-4 md:h-6" />
        </Button>
        <div className="group relative w-full">
          ...
          <Image
            ...
            width={1000}
            height={1000}
            className="relative flex items-center mx-auto rounded-lg w-full md:w-[1200px] max-h-96 object-cover leading-none"
            priority
            loading="eager"
          />
